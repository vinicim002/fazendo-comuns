...
export function AssistentesListPage() {
  ...
  const deleteAssistente = useAdminStore((s) => s.deleteAssistente)
  const toggleStatus = useAdminStore((s) => s.toggleAssistenteStatus)
  const reorder = useAdminStore((s) => s.reorderAssistentes)
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          onAction={() => (window.location.href = '/admin/assistentes/novo')}
        />
      ) : (
